...
6. **Links** [Bootstrap](https://getbootstrap.com/docs/4.3/components/buttons/) buttons and css formatted text links allow users readily access supplier websites, social links and a pdf of drawings. 
